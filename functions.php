...
//случайный выбор ФИО из массива
$personID = $example_persons_array[random_int(0, count($example_persons_array) - 1)]['fullname'];//строка


//вывод ФИО в новый массив
...
//определение процента женщин и мужчин в массиве
